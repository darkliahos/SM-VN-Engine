...
namespace VNNLangaugeTests.ParserTests
{
    ...
    public class AddCharacterTests
    {
        ...
        public void Parse_WhenCharacterDoesNotExistAddCharacter()
        {
            ...
            var command = "Add Character Sam Bridge the Elder *Happy* Fade In";
            var characterName = "Sam Bridge The Elder";
            var fakeImage = new byte[1];

            var instructor = new Mock<IInstructor>();
            var contentManager = new Mock<IContentManager>();
            instructor.Setup(i=> i.AddCharacter(It.IsAny<string>(), It.IsAny<byte[]>(), Animation.FadeIn, 0, 0));
            ...
            // Assert
            instructor.Verify(i => i.AddCharacter(characterName, fakeImage, Animation.FadeIn, 0, 0));
